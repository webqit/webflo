...
+ [The HTML Standard](https://html.spec.whatwg.org/) for all things *markup* - conventional `.html`-based pages, templates (partials), etc. You go with a "zero-JavaScript" proposition or progressively enhance with "just-enough JavaScript"!
